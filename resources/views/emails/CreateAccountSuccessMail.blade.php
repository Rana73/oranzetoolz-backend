...
<head>
    ...
    <title>Congratulations!. Your Account has been Created Successfully</title>
    <style>
        .logo-area{
          margin-bottom: 100px;  
        }
...
<div class="template" style="padding: 50px;">
		<div class="template-text">
		    ...
		    <h4>Your Account Username: {{ $user['email']  }}</h4>

            {{-- <h4>To login your account click the login button.</h4><br>
